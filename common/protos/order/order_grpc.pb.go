...
type ServiceClient interface {
	...
	OrderPayedPriceUpdateService(ctx context.Context, in *OrderPayedPriceUpdateRequest, opts ...grpc.CallOption) (*OrderPayedPriceUpdateResponse, error)
}
...
func (c *serviceClient) OrderPayedPriceUpdateService(ctx context.Context, in *OrderPayedPriceUpdateRequest, opts ...grpc.CallOption) (*OrderPayedPriceUpdateResponse, error) {
	out := new(OrderPayedPriceUpdateResponse)
	err := c.cc.Invoke(ctx, "/proto.Service/OrderPayedPriceUpdateService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	...
	OrderPayedPriceUpdateService(context.Context, *OrderPayedPriceUpdateRequest) (*OrderPayedPriceUpdateResponse, error)
...
func (UnimplementedServiceServer) OrderPayedPriceUpdateService(context.Context, *OrderPayedPriceUpdateRequest) (*OrderPayedPriceUpdateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method OrderPayedPriceUpdateService not implemented")
}
...
func _Service_OrderPayedPriceUpdateService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OrderPayedPriceUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).OrderPayedPriceUpdateService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Service/OrderPayedPriceUpdateService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).OrderPayedPriceUpdateService(ctx, req.(*OrderPayedPriceUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OrderPayedPriceUpdateService",
			Handler:    _Service_OrderPayedPriceUpdateService_Handler,
		},
	},
